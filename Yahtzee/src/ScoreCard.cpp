...
void ScoreCard::saveCard(string name){
    fstream out;
    out.open("res/PlayerSaves/"+name+".sav",ios::out);
    //Save Current Game
...
void ScoreCard::replaceCard(string name){
    fstream in;
    in.open("res/PlayerSaves/"+name+".sav",ios::in);
    string temp;
    int val;
    //Get current game
    in>>temp;
...
bool ScoreCard::setScoreCell(string scoreSec, Dice dice){
    ...
    string ones     =upperName[0];
    string twos     =upperName[1];
    string threes   =upperName[2];
    string fours    =upperName[3];
    string fives    =upperName[4];
    string sixes    =upperName[5];
    string threeKind=lowerName[6];
    string fourKind =lowerName[7];
